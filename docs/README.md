# 📚 Documentação Oficial - Registro de Treinos PWA (v1.9.0)
...
| **[COMPONENTS.md](./COMPONENTS.md)** | Catálogo DRY de componentes (`common/`, `dashboard/`, `protocols/`, `workout/`, `history/`, `ui/`). |
...
| **[ROADMAP.md](./ROADMAP.md)** | Histórico evolutivo completo de todos os 5 níveis e fases ativas consolidadas. |
