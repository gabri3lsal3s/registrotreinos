...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`min-h-screen bg-background text-foreground ${showNav ? 'pb-40' : 'pb-10'}`}>
      <main className="max-w-5xl mx-auto px-5 pt-8 md:pt-12 animate-in fade-in slide-in-from-bottom-2 duration-700 ease-out">
        {children}
      </main>
