        ...
        <aside className="hidden md:flex flex-col w-64 fixed left-0 top-0 bottom-0 border-r border-border/50 bg-card/60 backdrop-blur-xl z-40 p-5 justify-between select-none">
          ...
          <div className="space-y-3 pt-4 border-t border-border/40">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-muted/30 hover:bg-muted text-muted-foreground hover:text-foreground text-xs font-bold transition-all active:scale-[0.98]"
            >
