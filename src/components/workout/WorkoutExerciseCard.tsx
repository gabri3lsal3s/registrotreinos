...
import { triggerHapticFeedback } from '../../utils/audioFeedback';
...
export function WorkoutExerciseCard({
  ...
  const handleSetCheck = (setIdx: number) => {
  ...
  return (
    <>
      <Card className={`overflow-hidden border transition-all duration-200 rounded-2xl ${
        ...
        {/* Conteúdo Expandido – Tabela Ergonômica de Séries */}
        {isExpanded && (
          <CardContent className="p-3 sm:p-4 pt-0 border-t border-border/30 bg-muted/5 animate-in fade-in-50 duration-200">
